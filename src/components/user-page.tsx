...
interface Users {
  ...
  const initialUsers: Users[] = [
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:32 ,usertype:"business" ,status:"Deleted"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:35 ,usertype:"business" ,status:"Activated"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Activated"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Activated"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Deleted"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Activated"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Activated"},
    { name: "Cameron Williamson", email: "cameron@gmail.com", country: "india" , phone:9913141387 , key:36 ,usertype:"business" ,status:"Activated"},
  ];
...
export default function User() {
  ...
  const [userdatas, setUserdatas] = useState<Users[]>(initialUsers);
          ...
          <Col className="wlc_card bg-light" md={9}>
              <div className='main_card List_card d-flex justify-content-between flex-wrap'>
                    ...
                    <Col md={7} sm={12} className='d-flex justify-content-between flex-wrap w-100 p-0 mt-2'>
                        ...
                        <Button className='border_radias form-control Input_button_emp border_radius'><Link to='/createpage' className='text-white text-decoration-none link_tag'>Add User</Link></Button>
                    </Col>
              </div>
              <br />
