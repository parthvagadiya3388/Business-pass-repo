...
export default function UserlistInf() {
  ...
  const currentUsers = filteredUsers.slice(0, (currentPage + 1) * itemsPerPage);
 console.log("curentusers" , currentUsers)
      ...
      <Container>
        <Row>
          ...
          <Col className="wlc_card bg-light" md={9}>
            ...
            <br />
            <Col className="table-responsive p-0 user-list-table">
              <InfiniteScroll
